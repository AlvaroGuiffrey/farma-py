...
class CargaLIControl():
    ...
    def __init__(self):
        ...
        self.proveedor = 'COOP. FARMACEUTICA DEL LITORAL LTDA'
        self.nro_doc = 30541519218
        self.archivo = './archivos/LIMovimientos.csv'
        self.form = ''
        self.datos_pg = {}
        self.alertas = []
        self.opciones = []
    ...
    def carga_datos(self, dato):
        ...
        self.prov_recibido.set_punto_venta(dato[1][1:5])
        self.prov_recibido.set_numero(dato[1][6:])
        ...
        self.prov_recibido.set_perc_dgr(self.importe_db(dato[6]))
        ...
        self.prov_recibido.set_importe_total(self.importe_db(dato[7]))
